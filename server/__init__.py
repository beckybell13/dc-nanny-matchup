...
def init_db():
    ...
    # Pre-load dummy data
    initial_data = pandas.read_csv('server/static/dummy_data.csv')
    initial_data.to_sql(con=engine, name=Listing.__tablename__, if_exists='append', index='listing_id')
